        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 py-3 border-t border-hairline shrink-0 text-xs text-ink-muted bg-surface-muted/10 px-1 mt-1 rounded-md">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              >
                <SelectTrigger className="h-8 w-20 border border-hairline rounded bg-surface focus:outline-none focus:ring-1 focus:ring-primary font-semibold text-ink text-xs cursor-pointer hover:bg-surface-muted transition-colors">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
